...
(function(Buffer, process) {
    ...
    return function e(t, n, o) {
      ...
      2: [function(t, e, n) {
        ...
        function v(t, e, n, o) {
          0 > e && (e = 65535 + e + 1);
          for (var r = 0,
              i = Math.min(t.length - n, 2); i > r; r++)
            t[n + r] = (e & 255 << 8 * (o ? r : 1 - r)) >>> 8 * (o ? r : 1 - r);
        }
        function E(t, e, n, o) {
          0 > e && (e = 4294967295 + e + 1);
          for (var r = 0,
              i = Math.min(t.length - n, 4); i > r; r++)
        ...
        o.TYPED_ARRAY_SUPPORT = function() {
          ...
          if ("undefined" != typeof Uint8Array) {
            ...
            for (var t = new Uint8Array(this.length),
                e = 0,
                n = t.length; n > e; e += 1)
              t[e] = this[e];
            return t.buffer;
      ...
      7: [function(t, e) {
        ...
        e.exports = function(t, e, s) {
          ...
          for (var u = 0,
              p = 0; p < a.length && !(e >= u && p === a.length - 1); p++) {
            if (u >= e) {
              var g = e - u;
              if (g) {
      ...
      18: [function(t, e) {
        jsts = {
          ...
          multilinestring: function(t) {
            ...
            for (var e,
                n = t.trim().split(this.regExes.parenComma),
                o = [],
                r = 0,
                i = n.length; i > r; ++r)
          ...
          polygon: function(t) {
            ...
            for (var e,
                ...
                o,
                r,
                i = t.trim().split(this.regExes.parenComma),
                s = [],
                a = 0,
                u = i.length; u > a; ++a)
          ...
          multipolygon: function(t) {
            ...
            for (var e,
                n = t.trim().split(this.regExes.doubleParenComma),
                o = [],
                r = 0,
                i = n.length; i > r; ++r)
 ...
 while (t[s].equals2D(n) && s !== o);
          ...
          for (var n = t.iterator(),
              o = e.iterator(); n.hasNext() && o.hasNext(); ) {
            var r = n.next(),
                i = o.next(),
                s = r.compareTo(i);
            if (0 !== s)
          ...
          for (var t = [jsts.geom.Point, jsts.geom.MultiPoint, jsts.geom.LineString, jsts.geom.LinearRing, jsts.geom.MultiLineString, jsts.geom.Polygon, jsts.geom.MultiPolygon, jsts.geom.GeometryCollection],
              e = 0; e < t.length; e++)
          ...
          for (var e = new jsts.geom.CoordinateList,
              n = 0; n < this.pts.length; n++)
          ...
          jsts.operation.relate.RelateComputer = function(t) {
            ...
            for (var n = this.arg[e].getEdgeIterator(); n.hasNext(); )
              for (var o = n.next(),
                  r = o.getLabel().getLocation(e),
                  i = o.getEdgeIntersectionList().iterator(); i.hasNext(); ) {
                var s = i.next(),
          ...
          jsts.geom.Polygon = function(t, e, n) {
            ...
            for (var r = 0; r < this.holes.length; r++)
              for (var i = this.holes[r].getCoordinates(),
                  s = 0; s < i.length; s++)
                e++, t[e] = i[s];
            return t;
          ...
          jsts.geom.GeometryCollection = function(t, e) {
            ...
            for (var t = 0,
                e = this.geometries.length; e > t; t++) {
            ...
            for (var t = 0,
                e = 0,
                n = this.geometries.length; n > e; e++)
            ...
            for (var t = [],
                e = -1,
                n = 0,
                o = this.geometries.length; o > n; n++)
              for (var r = this.getGeometryN(n),
                  i = r.getCoordinates(),
                  s = 0; s < i.length; s++)
                e++, t[e] = i[s];
            return t;
            ...
            for (var t = jsts.geom.Dimension.FALSE,
                e = 0,
                n = this.geometries.length; n > e; e++) {
            ...
            for (var t = new jsts.geom.Envelope,
                e = 0,
                n = this.geometries.length; n > e; e++) {
              var o = this.getGeometryN(e);
          ...
          for (var e = !jsts.algorithm.CGAlgorithms.isCCW(t),
              n = 0; n < t.length - 1; n++)
          ...
          t.findEdgeRingContaining = function(t, e) {
            ...
            if (null == this.ringPts) {
              for (var e = new jsts.geom.CoordinateList,
                  n = this.deList.iterator(); n.hasNext(); ) {
                var o = n.next(),
                    r = o.getEdge();
          ...
          p.prototype = new a, p.getDegreeNonDeleted = function(t) {
            ...
            for (var n = new t,
                o = this.dirEdges.iterator(); o.hasNext(); ) {
              var r = o.next();
 ...
 while (e != t);
            ...
            for (; !r.isEmpty(); ) {
              var s = r.pop();
              p.deleteAllEdges(s);
              for (var a = s.getOutEdges().getEdges(),
 ...
 while (t != this.startDe);
          ...
          for (var o = e.getChildBoundables(),
              r = 0; r < o.length; r++) {
            var i = o[r];
          ...
          if (jsts.util.Assert.isTrue(t > -2), e.getLevel() === t)
            return void n.add(e);
          for (var o = node.getChildBoundables(),
              r = 0; r < o.length; r++) {
            var i = o[r];
          ...
          return (t + e) / 2;
        }, jsts.index.strtree.STRtree.prototype.intersectsOp = {intersects: function(t, e) {
            return t.intersects(e);
          }}, jsts.index.strtree.STRtree.prototype.createParentBoundables = function(t, e) {
          jsts.util.Assert.isTrue(!(0 === t.length));
          for (var n = Math.ceil(t.length / this.getNodeCapacity()),
              o = [],
              r = 0; r < t.length; r++)
            o.push(t[r]);
          ...
          for (var n = [],
              o = jsts.index.chain.MonotoneChainBuilder.getChainStartIndices(t),
              r = 0; r < o.length - 1; r++) {
          ...
          if (n >= t.length - 1)
            return t.length - 1;
          for (var o = jsts.geomgraph.Quadrant.quadrant(t[n], t[n + 1]),
              r = e + 1; r < t.length; ) {
          ...
          i.prototype = new t, i.constructor = i, i.prototype.si = null, i.prototype.overlap = function(t, e, n, o) {
            ...
            for (var t = new i(this.segInt),
                e = 0; e < this.monoChains.length; e++)
              for (var n = this.monoChains[e],
                  o = this.index.query(n.getEnvelope()),
                  r = 0; r < o.length; r++) {
                var s = o[r];
            ...
            for (var e = r.getChains(t.getCoordinates(), t),
                n = 0; n < e.length; n++) {
              var o = e[n];
          ...
          for (var e = jsts.geom.Location.NONE,
              n = this.iterator(); n.hasNext(); ) {
            var o = n.next(),
                r = o.getLabel();
          ...
          for (var o = new jsts.geom.LineSegment,
              r = t.getCoordinates(),
              i = 0; i < r.length - 1; i++) {
          ...
          for (var e = new javascript.util.TreeMap,
          ...
          for (var e = new javascript.util.ArrayList,
              n = 0; n < t.length; n++) {
            var o = t[n],
          ...
          jsts.geomgraph.DirectedEdgeStar = function() {
            ...
            for (var t = null,
                ...
                r = 0; r < this.resultAreaEdgeList.size(); r++) {
            ...
            for (var e = null,
                n = null,
                r = this.SCANNING_FOR_INCOMING,
                i = this.resultAreaEdgeList.size() - 1; i >= 0; i--) {
          ...
          for (var n = 0,
              o = this.g0.getNumGeometries(); o > n; n++) {
          ...
          for (var t = new jsts.algorithm.PointLocator,
              e = [],
              n = 0,
              o = this.pointGeom.getNumGeometries(); o > n; n++) {
          ...
          for (var e,
              n = t.getEdgeEnds().iterator(); n.hasNext(); )
 ...
 while (n != e);
          ...
          for (var t = jsts.geom.CoordinateArrays.removeRepeatedPoints(this.ring.getCoordinates()),
              e = jsts.index.chain.MonotoneChainBuilder.getChains(t),
              n = 0; n < e.length; n++) {
            var o = e[n],
                r = o.getEnvelope();
          ...
          for (var n = this.tree.query(this.interval),
              o = new jsts.algorithm.MCPointInRing.MCSelecter(t, this),
              r = n.iterator(); r.hasNext(); ) {
            var i = r.next();
          ...
          for (var o = e.getEdge().getCoordinates(),
              r = 0; r < o.length - 1; r++) {
 ...
 while (e);
          ...
          if (!(1 > a)) {
            ...
            u = 0, p = s / a;
            for (var g = u,
                l = new jsts.geom.Coordinate; s > g; ) {
              var h = e + i * g;
 ...
 while (null !== i);
          ...
          s.prototype.origin = null, s.prototype.compare = function(t, e) {
            ...
            for (var o = new javascript.util.TreeSet,
                r = 0; r < n.length; r++)
              o.add(n[r]);
          ...
          for (var o = e.distancePerpendicular(t[n]),
              r = o,
              i = n,
              s = i; r >= o; )
          ...
          for (var t = this.minBaseSeg.p1.x - this.minBaseSeg.p0.x,
              ...
              r = Number.MAX_VALUE,
              i = -Number.MAX_VALUE,
              s = 0; s < this.convexHullPts.length; s++) {
          ...
          jsts.io.GeoJSONParser = function(t) {
            ...
            Polygon: function(t) {
              for (var e = this.parse.coordinates.apply(this, [t[0]]),
          ...
          for (var o = n.findEdge(e),
              r = o.getEdgeIntersectionList(),
              i = 0; i < t.length; i++) {
            var s = t[i];
          ...
          for (var n = new jsts.operation.valid.IndexedNestedRingTester(e),
 ...
 while (e.lNext() != o);
          ...
          for (var n = jsts.geomgraph.Quadrant.quadrant(t[e], t[e + 1]),
              o = e + 1; o < t.length; ) {
          ...
          for (var t = new jsts.index.strtree.STRtree(this.STRTREE_NODE_CAPACITY),
              e = 0,
              n = this.inputPolys.length; n > e; e++) {
          ...
          for (var o = new javascript.util.ArrayList,
          ...
          t.prototype = new jsts.index.chain.MonotoneChainSelectAction, t.constructor = t, t.prototype.hotPixel = null, t.prototype.parentEdge = null, t.prototype.vertexIndex = null, t.prototype._isNodeAdded = !1, t.prototype.isNodeAdded = function() {
            ...
            var r = e.getSafeEnvelope(),
                i = new t(e, n, o);
            return this.index.query(r, {visitItem: function(t) {
                t.select(r, i);
              }}), i.isNodeAdded();
        ...
        }, jsts.index.strtree.SIRtree.prototype = new jsts.index.strtree.AbstractSTRtree, jsts.index.strtree.SIRtree.constructor = jsts.index.strtree.SIRtree, jsts.index.strtree.SIRtree.prototype.comperator = {compare: function(t, e) {
            return t.getBounds().getCentre() - e.getBounds().getCentre();
          }}, jsts.index.strtree.SIRtree.prototype.intersectionOp = {intersects: function(t, e) {
            return t.intersects(e);
          ...
          jsts.operation.relate.RelateNodeGraph = function() {
            ...
            for (var o = e.getEdgeIterator(); o.hasNext(); )
              for (var r = o.next(),
                  i = r.getLabel().getLocation(n),
                  s = r.getEdgeIntersectionList().iterator(); s.hasNext(); ) {
                var a = s.next(),
          ...
          for (var t = 0; t < this.rings.size(); t++)
            for (var e = this.rings.get(t),
                n = e.getCoordinates(),
                o = this.index.query(e.getEnvelopeInternal()),
                r = 0; r < o.length; r++) {
              var i = o[r],
                  s = i.getCoordinates();
          ...
          for (var n = new jsts.algorithm.RayCrossingCounter(t),
              o = 1; o < e.length; o++) {
            var r = e[o],
                i = e[o - 1];
          ...
          if (t instanceof jsts.geom.GeometryCollection) {
            ...
            if (e.isEmpty())
              return e;
            for (var n = e.getGeometryN(0),
                o = 1; o < e.getNumGeometries(); o++)
          ...
          e.prototype = new jsts.geom.util.ShortCircuitedGeometryVisitor, e.constructor = e, e.prototype.rectSeq = null, e.prototype.rectEnv = null, e.prototype.containsPoint = !1, e.prototype.containsPoint = function() {
            ...
            if (t instanceof jsts.geom.Polygon) {
              var e = t.getEnvelopeInternal();
              if (this.rectEnv.intersects(e))
                for (var n = new jsts.geom.Coordinate,
                    o = 0; 4 > o; o++)
          ...
          n.computeNodes(t);
          for (var o = n.getNodedSubstrings(),
              r = o.iterator(); r.hasNext(); ) {
            var i = r.next(),
                s = i.getData(),
          ...
          for (var e = new jsts.geom.GeometryFactory,
              n = new javascript.util.ArrayList; t.hasNext(); ) {
            var o = t.next(),
 ...
 while (t !== startQE);
          ...
          o.prototype = new jsts.geom.CoordinateSequenceFilter, o.prototype.maxPtDist = new t, o.prototype.minPtDist = new t, o.prototype.geom, o.prototype.numSubSegs = 0, o.prototype.filter = function(t, n) {
            if (0 != n)
              for (var o = t[n - 1],
                  r = t[n],
                  i = (r.x - o.x) / this.numSubSegs,
                  s = (r.y - o.y) / this.numSubSegs,
                  a = 0; a < this.numSubSegs; a++) {
                var u = o.x + a * i,
                    p = o.y + a * s,
          ...
          for (var o = jsts.algorithm.MinimumBoundingCircle.lowestPoint(t),
              r = jsts.algorithm.MinimumBoundingCircle.pointWitMinAngleWithX(t, o),
              i = 0; i < t.length; i++) {
 ...
 while (null !== r);
      ...
      31: [function(t, e) {
        "use strict";
        function n(t, e) {
          for (var n = new Array(e + 1),
              o = 0; o < t.length; ++o)
            n[o] = t[o];
          for (var o = 0; o <= t.length; ++o) {
            for (var i = t.length; e >= i; ++i) {
              for (var s = new Array(e),
                  a = 0; e > a; ++a)
      ...
      37: [function(t, e) {
        "use strict";
        function n(t, e) {
          for (var n = new Array(t.length - 1),
              o = 1; o < t.length; ++o)
            for (var r = n[o - 1] = new Array(t.length - 1),
                i = 0,
                s = 0; i < t.length; ++i)
              i !== e && (r[s++] = t[o][i]);
          return n;
        ...
        function p() {
          ...
          for (var r = ["function getOrientation(", t.join(), "){switch(arguments.length){case 0:case 1:return 0;"],
              o = 2; c >= o; ++o)
      ...
      38: [function(t, e) {
        ...
        function i(t) {
          for (var e = ["function orient(){var tuple=this.tuple;return test("],
              n = 0; t >= n; ++n)
        ...
        function a(t, e) {
          ...
          for (var p = new Array(r + 1),
              g = 0; r >= g; ++g)
            p[g] = g;
          0 > a && (p[0] = 1, p[1] = 0);
          for (var l = new n(p, new Array(r + 1), !1),
              h = l.adjacent,
              d = new Array(r + 2),
              g = 0; r >= g; ++g) {
            for (var c = p.slice(),
        ...
        l.handleBoundaryDegeneracy = function(t, e) {
          ...
          for (t.lastVisited = -o; s.length > 0; ) {
            t = s.pop();
            for (var a = (t.vertices, t.adjacent),
                u = 0; n >= u; ++u) {
              var p = a[u];
              if (p.boundary && !(p.lastVisited <= -o)) {
                for (var g = p.vertices,
                    l = 0; n >= l; ++l) {
                  var h = g[l];
                  r[l] = 0 > h ? e : i[h];
                }
      ...
      47: [function(t, e, n) {
        ...
        function c(t, e) {
          ...
          for (var n = [],
              ...
              r = 0; r < t.length; ++r)
            for (var i = t[r],
                s = o; s < 1 << i.length; s = v.nextCombination(s)) {
              for (var a = new Array(e + 1),
                  p = 0,
                  g = 0; g < i.length; ++g)
                s & 1 << g && (a[p++] = i[g]);
              n.push(a);
        ...
        function f(t) {
          for (var e = [],
            ...
            for (var r = t[n],
                i = 0,
                s = r.length; s > i; ++i) {
              for (var a = new Array(r.length - 1),
                  p = 0,
                  g = 0; s > p; ++p)
                p !== i && (a[g++] = r[p]);
              e.push(a);
      ...
      48: [function(t, e) {
        ...
        function n(t) {
          ...
          for (var s = [i[0], i[1]],
            ...
            for (var u = i[r],
                p = t[u],
                g = s.length; g > 1 && o(t[s[g - 2]], t[s[g - 1]], p) <= 0; )
              g -= 1, s.pop();
            for (s.push(u), g = a.length; g > 1 && o(t[a[g - 2]], t[a[g - 1]], p) >= 0; )
              g -= 1, a.pop();
            a.push(u);
          }
          for (var n = new Array(a.length + s.length - 2),
              l = 0,
              r = 0,
              h = s.length; h > r; ++r)
            n[l++] = s[r];
 ...
 while (1 - U > o);
      ...
      75: [function(t, e) {
        ...
        for (var o = t("turf-point"),
            r = t("turf-polygon"),
            i = t("turf-distance"),
            s = t("turf-featurecollection"),
            a = [],
            u = [],
            p = 0; 6 > p; p++) {
          var g = 2 * Math.PI / 6 * p;
      ...
      82: [function(t, e) {
        ...
        r.prototype.remove_seq = function(t) {
          ...
          for (var r = this.s,
              ...
              s = null,
              a = !1,
              u = !1; r && (null == i && (n(t, r.head.p) ? (i = r, a = !0) : n(t, r.tail.p) && (i = r)), null == s && (n(e, r.head.p) ? (s = r, u = !0) : n(e, r.tail.p) && (s = r)), null == s || null == i); )
            r = r.next;
          ...
          for (var f,
              ...
              b = [0, 1, 1, 0],
              P = [0, 0, 1, 1],
              R = [[[0, 0, 8], [0, 2, 5], [7, 6, 9]], [[0, 3, 4], [1, 3, 1], [4, 3, 0]], [[9, 6, 7], [5, 2, 0], [8, 0, 0]]],
              w = r - 1; w >= o; w--)
            for (var O = e; n - 1 >= O; O++) {
              var M,
                  A;
      ...
      83: [function(t, e) {
        ...
        e.exports = function(t, e, l, h) {
          for (var d = n(t, e),
              ...
              m = r(f, l),
              y = [],
              j = 0; j < m.features.length; j++)
            for (var v = m.features[j],
                E = 0; E < d.features.length; E++) {
              var x = d.features[E];
              o(v, x) && (v.properties = {}, v.properties[e] = s(v, x));
            }
          for (var I = Math.sqrt(m.features.length),
              S = 0; I > S; S++) {
      ...
      89: [function(t, e) {
        ...
        e.exports = function(t, e, o) {
          ...
          for (var p = s([i[0].geometry.coordinates], {}),
              g = i[0].properties.index + 1; g < i[1].properties.index + 1; g++)
      ...
      99: [function(t, e) {
        ...
        e.exports = function(t, e, i) {
          for (var s = o([]),
              a = e / r(n([t[0], t[1]]), n([t[2], t[1]]), i),
              u = a * (t[2] - t[0]),
              p = e / r(n([t[0], t[1]]), n([t[0], t[3]]), i),
              g = p * (t[3] - t[1]),
              l = t[0]; l <= t[2]; ) {
            for (var h = t[1]; h <= t[3]; )
        ...
        e.exports = function(t) {
          ...
          for (var e = r(t),
            ...
            if ("Point" === g.type)
              ...
              for (var E = !1,
                  x = 0; !E && x < g.coordinates.length; ) {
                for (var d = !1,
                    h = 0,
                    I = g.coordinates[x]; !d && h < I.length - 1; ) {
                  var c = e.geometry.coordinates[0],
                      f = e.geometry.coordinates[1],
                      m = I[h][0],
                      y = I[h][1],
      ...
      114: [function(t, e) {
        ...
        e.exports = function(t, e, s) {
          for (var a = n([]),
              u = e / i(o([t[0], t[1]]), o([t[2], t[1]]), s),
              p = u * (t[2] - t[0]),
              g = e / i(o([t[0], t[1]]), o([t[0], t[3]]), s),
              l = g * (t[3] - t[1]),
              h = t[0]; h <= t[2]; ) {
            for (var d = t[1]; d <= t[3]; ) {
