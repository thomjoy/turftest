...
test('hex-grid', function(t) {
  ...
  var bbox2 = [-81.650390625, 24.926294766395593, -79.8486328125, 26.43122806450644];
  var bbox3 = [-77.3876953125, 38.71980474264239, -76.9482421875, 39.027718840211605];
  var bbox4 = [63.6328125, 11.867350911459308, 75.234375, 47.754097979680026];
  ...
  t.equal(grid([-96.6357421875, 31.12819929911196, -84.9462890625, 40.58058466412764], 100, 'miles').features.length, 70);
