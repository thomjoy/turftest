...
require("tape")(function(t) {
  var testValues = [0, 1, Math.pow(2, -52), Math.pow(2, -53), 1.0 - Math.pow(2, -53), 1.0 + Math.pow(2, -52), Math.pow(2, -500), Math.pow(2, 500), 2, 0.5, 3, 1.5, 0.1, 0.3, 0.7];
  for (var i = 0; i < 20; ++i) {
  ...
  t.same(twoProduct(1.0 + Math.pow(2, -52), 1.0 + Math.pow(2, -52)), [Math.pow(2, -104), 1.0 + Math.pow(2, -51)], "test expansion");
  t.end();
});
