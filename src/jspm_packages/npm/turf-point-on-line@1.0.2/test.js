...
test('turf-point-on-line -- line1', function(t) {
  ...
  fs.writeFileSync(__dirname + '/fixtures/out/line1_out.geojson', JSON.stringify(featurecollection([line1, pt, snapped]), null, 2));
  t.end();
});
test('turf-point-on-line -- line2', function(t) {
  ...
  snapped.properties['marker-color'] = '#f0f';
  t.equal(snapped.geometry.type, 'Point');
  fs.writeFileSync(__dirname + '/fixtures/out/line2_out.geojson', JSON.stringify(featurecollection([line2, pt, snapped]), null, 2));
  t.end();
});
test('turf-point-on-line -- route1', function(t) {
  ...
  snapped.properties['marker-color'] = '#f0f';
  t.equal(snapped.geometry.type, 'Point');
  fs.writeFileSync(__dirname + '/fixtures/out/route1_out.geojson', JSON.stringify(featurecollection([route1, pt, snapped]), null, 2));
  t.end();
});
test('turf-point-on-line -- route2', function(t) {
  ...
  snapped.properties['marker-color'] = '#f0f';
  t.equal(snapped.geometry.type, 'Point');
  fs.writeFileSync(__dirname + '/fixtures/out/route2_out.geojson', JSON.stringify(featurecollection([route2, pt, snapped]), null, 2));
  t.end();
});
