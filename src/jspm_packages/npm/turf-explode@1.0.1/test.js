...
test('explode', function(t) {
  ...
  t.deepEqual(explode(polygon([[[0, 0], [1, 1], [0, 1], [0, 0]]])), featurecollection([point([0, 0]), point([1, 1]), point([0, 1]), point([0, 0])]), 'explode a polygon');
  t.deepEqual(explode(linestring([[0, 0], [1, 1], [0, 1], [0, 0]])), featurecollection([point([0, 0]), point([1, 1]), point([0, 1]), point([0, 0])]), 'explode a linestring');
  t.throws(function() {
    explode({});
