...
test('point-on-surface -- centroid on polygon surface', function(t) {
  ...
  t.true(inside(cent, {
    ...
    "geometry": {
      "type": "Polygon",
      "coordinates": [[[13.270797729492186, 52.42042920678164], [13.270797729492186, 52.573846203920276], [13.5186767578125, 52.573846203920276], [13.5186767578125, 52.42042920678164], [13.270797729492186, 52.42042920678164]]]
    }
  }));
  t.end();
});
