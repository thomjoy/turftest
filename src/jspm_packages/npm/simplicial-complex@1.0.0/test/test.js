...
test("dimension", function(t) {
  t.equals(top.dimension([[0], [], [1, 2, 3], [4, 5]]), 2);
  t.end();
});
test("countVertices", function(t) {
  t.equals(top.countVertices([[1, 2, 3], [5, 6], [1000, 1]]), 1001);
...
test("skeleton", function(t) {
  var r = [[1, 2, 3]];
  arr_equals(t, top.unique(top.normalize(top.skeleton(r, 1))), [[1, 2], [1, 3], [2, 3]]);
  var h = [[1, 2, 3], [2, 3, 4]];
  arr_equals(t, top.unique(top.normalize(top.skeleton(h, 1))), [[1, 2], [1, 3], [2, 3], [2, 4], [3, 4]]);
  var k = [[1, 2, 3, 4, 5, 6, 7, 8]];
  arr_equals(t, top.normalize(top.skeleton(k, 0)), [[1], [2], [3], [4], [5], [6], [7], [8]]);
  var s = [[0, 1, 2, 3]];
  arr_equals(t, top.skeleton(s, 2), [[0, 1, 2], [0, 1, 3], [0, 2, 3], [1, 2, 3]]);
  t.end();
});
...
test("buildIndex", function(t) {
  var from_cells = top.normalize([[0, 1], [0, 2], [1, 2], [1, 3], [2, 3]]);
  var to_cells = top.normalize([[0, 1, 2], [0, 1, 3], [0, 2, 3], [1, 2, 3]]);
...
test("dual", function(t) {
  var cells = top.normalize([[1, 2, 3], [0], [5, 6, 7], [8, 3], [4, 6], [2, 5], [2, 7], [2, 0]]);
...
test("boundary", function(t) {
  var tris = top.normalize([[0, 1, 2], [0, 1, 3], [0, 2, 3], [1, 2, 3]]);
  var tetra = [[0, 1, 2, 3]];
...
test("explode", function(t) {
  ...
  console.log(e);
  arr_equals(t, e, top.normalize([[0], [1], [2], [0, 1], [1, 2], [2, 0], [0, 1, 2]]));
  t.end();
});
test("connectedComponents", function(t) {
  var graph = top.normalize([[0, 1], [1, 2], [2, 3], [5, 6], [4], [4, 7, 8]]);
