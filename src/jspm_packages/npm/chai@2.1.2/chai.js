...
(function(Buffer) {
  ...
  (function() {
    ...
    require.register("chai/lib/chai.js", function(exports, module) {
      ...
      var util = require("./lib/chai/utils/index");
      ...
      exports.util = util;
      var config = require("./lib/chai/config");
      exports.config = config;
      var assertion = require("./lib/chai/assertion");
      exports.use(assertion);
      var core = require("./lib/chai/core/assertions");
      exports.use(core);
      var expect = require("./lib/chai/interface/expect");
      exports.use(expect);
      var should = require("./lib/chai/interface/should");
      exports.use(should);
      var assert = require("./lib/chai/interface/assert");
      exports.use(assert);
    });
    ...
    require.register("chai/lib/chai/utils/addChainableMethod.js", function(exports, module) {
      var transferFlags = require("./lib/chai/utils/transferFlags");
      var flag = require("./lib/chai/utils/flag");
      var config = require("./lib/chai/config");
    ...
    require.register("chai/lib/chai/utils/getMessage.js", function(exports, module) {
      var flag = require("./lib/chai/utils/flag"),
          getActual = require("./lib/chai/utils/getActual"),
          inspect = require("./lib/chai/utils/inspect"),
          objDisplay = require("./lib/chai/utils/objDisplay");
      module.exports = function(obj, args) {
    ...
    require.register("chai/lib/chai/utils/getPathValue.js", function(exports, module) {
      var getPathInfo = require("./lib/chai/utils/getPathInfo");
    ...
    require.register("chai/lib/chai/utils/getPathInfo.js", function(exports, module) {
      var hasProperty = require("./lib/chai/utils/hasProperty");
    ...
    require.register("chai/lib/chai/utils/hasProperty.js", function(exports, module) {
      var type = require("./lib/chai/utils/type");
      var literals = {
        'number': Number,
        'string': String
      };
    ...
    require.register("chai/lib/chai/utils/index.js", function(exports, module) {
      ...
      exports.test = require("./lib/chai/utils/test");
      exports.type = require("./lib/chai/utils/type");
      exports.getMessage = require("./lib/chai/utils/getMessage");
      exports.getActual = require("./lib/chai/utils/getActual");
      exports.inspect = require("./lib/chai/utils/inspect");
      exports.objDisplay = require("./lib/chai/utils/objDisplay");
      exports.flag = require("./lib/chai/utils/flag");
      exports.transferFlags = require("./lib/chai/utils/transferFlags");
      exports.eql = require("chaijs~deep-eql@0.1.3");
      exports.getPathValue = require("./lib/chai/utils/getPathValue");
      exports.getPathInfo = require("./lib/chai/utils/getPathInfo");
      exports.hasProperty = require("./lib/chai/utils/hasProperty");
      exports.getName = require("./lib/chai/utils/getName");
      exports.addProperty = require("./lib/chai/utils/addProperty");
      exports.addMethod = require("./lib/chai/utils/addMethod");
      exports.overwriteProperty = require("./lib/chai/utils/overwriteProperty");
      exports.overwriteMethod = require("./lib/chai/utils/overwriteMethod");
      exports.addChainableMethod = require("./lib/chai/utils/addChainableMethod");
      exports.overwriteChainableMethod = require("./lib/chai/utils/overwriteChainableMethod");
    });
    require.register("chai/lib/chai/utils/inspect.js", function(exports, module) {
      var getName = require("./lib/chai/utils/getName");
      var getProperties = require("./lib/chai/utils/getProperties");
      var getEnumerableProperties = require("./lib/chai/utils/getEnumerableProperties");
    ...
    require.register("chai/lib/chai/utils/objDisplay.js", function(exports, module) {
      var inspect = require("./lib/chai/utils/inspect");
      var config = require("./lib/chai/config");
    ...
    if (typeof exports == "object") {
      ...
      (this || window)["chai"] = require("./index");
    }
  })();
