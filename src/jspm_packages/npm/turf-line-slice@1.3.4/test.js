...
test('turf-line-slice -- line1', function(t) {
  ...
  fs.writeFileSync(__dirname + '/fixtures/out/line1_out.geojson', JSON.stringify(featurecollection([line1, start, stop, sliced]), null, 2));
  t.end();
});
test('turf-line-slice -- line2', function(t) {
  ...
  sliced.properties['stroke'] = '#f0f';
  sliced.properties['stroke-width'] = 6;
  fs.writeFileSync(__dirname + '/fixtures/out/line2_out.geojson', JSON.stringify(featurecollection([line2, start, stop, sliced]), null, 2));
  t.end();
});
test('turf-line-slice -- route1', function(t) {
  ...
  sliced.properties['stroke'] = '#f0f';
  sliced.properties['stroke-width'] = 6;
  fs.writeFileSync(__dirname + '/fixtures/out/route1_out.geojson', JSON.stringify(featurecollection([route1, start, stop, sliced]), null, 2));
  t.end();
});
test('turf-line-slice -- route2', function(t) {
  ...
  sliced.properties['stroke'] = '#f0f';
  sliced.properties['stroke-width'] = 6;
  fs.writeFileSync(__dirname + '/fixtures/out/route2_out.geojson', JSON.stringify(featurecollection([route2, start, stop, sliced]), null, 2));
  t.end();
});
